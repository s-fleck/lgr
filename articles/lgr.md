...
readLines(tf)
#> [1] "INFO  [2026-06-03 05:10:14.593] You must think I am joking"
```
...
readLines(tf)
#> [1] "INFO  [2026-06-03 05:10:14.593] You must think I am joking"
#> [2] "INFO  [June 03 05:10:14] No, I am quite serious"
...
cat(readLines(tf))
#> {"level":400,"timestamp":"2026-06-03 05:10:14","logger":"root","caller":"eval","msg":"We lived in Styria"}
```
...
#> 1   400 2026-06-03 05:10:14   root   eval We lived in Styria
```
...
#> 1   400 2026-06-03 05:10:14   root   eval We lived in Styria            NULL
#> 2   400 2026-06-03 05:10:15   root   eval         Styria has capons, turkeys
...
#> INFO  [2026-06-03 05:10:15] Vampire stories are generally located in Styria
lgr$last_event$values  # all values stored in the event as a list
#> $level
#> [1] 400
#> 
#> $timestamp
#> [1] "2026-06-03 05:10:15 UTC"
#> 
#> $logger
#> [1] "root"
#> 
...
#> 1   400 2026-06-03 05:10:15   root   eval Processing track track.gpx        32
```
...
readLines(tf)
#> [1] "INFO  [2026-06-03 05:10:15.608] Another informational message"                    
#> [2] "DEBUG [2026-06-03 05:10:15.610] A debug message not shown by the console appender"
...
```
    ...
    #> 1   400 2026-06-03 05:10:16   test   eval JSON naturally  custom    NULL <NA>
    #> 2   400 2026-06-03 05:10:16   test   eval supports custom   <NA> 1, 2, 3 <NA>
    #> 3   400 2026-06-03 05:10:16   test   eval      log fields   <NA>    NULL JSON
...
```
    ...
    #> {"level":400,"timestamp":"2026-06-03 05:10:16","logger":"test","caller":"eval","msg":"JSON naturally ","field":"custom"}
    #> {"level":400,"timestamp":"2026-06-03 05:10:16","logger":"test","caller":"eval","msg":"supports custom","numbers":[1,2,3]}
    #> {"level":400,"timestamp":"2026-06-03 05:10:16","logger":"test","caller":"eval","msg":"log fields","use":"JSON"}
...
#> 1 /tmp/RtmpBVMVWh/file1e3f4b77b2cb.1.log file1e3f4b77b2cb   1 log 10608 FALSE
#> 2 /tmp/RtmpBVMVWh/file1e3f4b77b2cb.2.log file1e3f4b77b2cb   2 log 10608 FALSE
#> 3 /tmp/RtmpBVMVWh/file1e3f4b77b2cb.3.log file1e3f4b77b2cb   3 log 10608 FALSE
#> 4 /tmp/RtmpBVMVWh/file1e3f4b77b2cb.4.log file1e3f4b77b2cb   4 log 10608 FALSE
#> 5 /tmp/RtmpBVMVWh/file1e3f4b77b2cb.5.log file1e3f4b77b2cb   5 log 10608 FALSE
#>   mode               mtime               ctime               atime  uid  gid
#> 1  644 2026-06-03 05:10:16 2026-06-03 05:10:16 2026-06-03 05:10:16 1001 1001
#> 2  644 2026-06-03 05:10:16 2026-06-03 05:10:16 2026-06-03 05:10:16 1001 1001
#> 3  644 2026-06-03 05:10:16 2026-06-03 05:10:16 2026-06-03 05:10:16 1001 1001
#> 4  644 2026-06-03 05:10:16 2026-06-03 05:10:16 2026-06-03 05:10:16 1001 1001
#> 5  644 2026-06-03 05:10:16 2026-06-03 05:10:16 2026-06-03 05:10:16 1001 1001
#>    uname grname index
#> 1 runner runner     1
#> 2 runner runner     2
#> 3 runner runner     3
...
#> 
#> appenders:
#>   [[1]]: <AppenderFile> [all] -> /tmp/RtmpBVMVWh/file1e3f1f6e88d9
#> 
#> inherited appenders:
#>   console: <AppenderConsole> [info] -> console
```
