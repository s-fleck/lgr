...
- Optional support to use [glue](https://glue.tidyverse.org/) instead of
  [`sprintf()`](https://rdrr.io/r/base/sprintf.html) for composing log
  messages.
...
[`sprintf()`](https://rdrr.io/r/base/sprintf.html). For a way to create
loggers that [glue](https://glue.tidyverse.org/) instead please refer to
the vignette.
...
- [desc](https://CRAN.R-project.org/package=desc) for the package
  development convenience function
...
- [cli](https://CRAN.R-project.org/package=cli) for printing the tree
  structure of registered loggers with
