...
#> ERROR [13:44:01.330] an important error message
...
#> FATAL [13:44:01.340] Multiple console appenders are a bad idea
...
#> INFO  [13:44:01.346] a log message
lgr$info("another message with data", data = 1:3)
#> INFO  [13:44:01.347] another message with data {data: (1, 2, 3)}

show_log()
#> INFO  [13:44:01] a log message
#> INFO  [13:44:01] another message with data
show_data()
#>   level           timestamp logger caller                       msg
#> 1   400 2026-01-30 13:44:01   root   eval             a log message
#> 2   400 2026-01-30 13:44:01   root   eval another message with data
#>                      rawMsg    data
