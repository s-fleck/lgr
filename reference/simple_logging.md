...
#> ERROR [11:27:43.398] an important error message
...
#> FATAL [11:27:43.408] Multiple console appenders are a bad idea
...
#> INFO  [11:27:43.413] a log message
lgr$info("another message with data", data = 1:3)
#> INFO  [11:27:43.415] another message with data {data: (1, 2, 3)}

show_log()
#> INFO  [11:27:43] a log message
#> INFO  [11:27:43] another message with data
show_data()
#>   level           timestamp logger caller                       msg
#> 1   400 2026-01-30 11:27:43   root   eval             a log message
#> 2   400 2026-01-30 11:27:43   root   eval another message with data
#>                      rawMsg    data
