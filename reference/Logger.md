...
lg$fatal("blubb")
#> FATAL [05:02:21.138] blubb
readLines(tf)
#> [1] "FATAL [2026-06-03 05:02:21.138] blubb"
...
#> INFO  [05:02:21.146] Not all appenders support custom fields {type: `test`}
cat(readLines(tf), sep = "\n")
#> FATAL [2026-06-03 05:02:21.138] blubb
#> INFO  [2026-06-03 05:02:21.146] Not all appenders support custom fields {"type":"test"}
cat(readLines(tf2), sep = "\n")
#> {"level":400,"timestamp":"2026-06-03 05:02:21","logger":"mylogger","caller":"eval","msg":"Not all appenders support custom fields","type":"test"}
...
#> FATAL [05:02:21.155] blah fizz is set to: buzz {foo: `bar`, fizz: `buzz`}
#> FATAL [05:02:21.203] blah fizz is set to: buzz {foo: `bar`}
#> <Logger> [info] glue
#> 
#> inherited appenders:
#>   console: <AppenderConsole> [all] -> console
...
lgr$info(stop("this produces a warning instead of an error"))
#> Warning: [2026-06-03 05:02:21.232] root ~ error in `lgr$info(stop("this produces a warning instead of an error"))`: this produces a warning instead of an error
```
