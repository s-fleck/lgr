...
lg$fatal("blubb")
#> FATAL [05:10:03.864] blubb
readLines(tf)
#> [1] "FATAL [2026-06-03 05:10:03.864] blubb"
...
#> INFO  [05:10:03.871] Not all appenders support custom fields {type: `test`}
cat(readLines(tf), sep = "\n")
#> FATAL [2026-06-03 05:10:03.864] blubb
#> INFO  [2026-06-03 05:10:03.871] Not all appenders support custom fields {"type":"test"}
cat(readLines(tf2), sep = "\n")
#> {"level":400,"timestamp":"2026-06-03 05:10:03","logger":"mylogger","caller":"eval","msg":"Not all appenders support custom fields","type":"test"}
...
#> FATAL [05:10:03.881] blah fizz is set to: buzz {foo: `bar`, fizz: `buzz`}
#> FATAL [05:10:03.929] blah fizz is set to: buzz {foo: `bar`}
#> <Logger> [info] glue
#> 
#> inherited appenders:
#>   console: <AppenderConsole> [all] -> console
...
lgr$info(stop("this produces a warning instead of an error"))
#> Warning: [2026-06-03 05:10:03.959] root ~ error in `lgr$info(stop("this produces a warning instead of an error"))`: this produces a warning instead of an error
```
