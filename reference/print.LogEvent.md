...
print(x)
#> WARN  [2026-01-30 11:27:42] a test event
print(x, fmt = c("%t (%p) %c: %n - %m"))
#> 2026-01-30 11:27:42 (7159) testfun(): 300 - a test event
print(x, colors = NULL)
#> WARN  [2026-01-30 11:27:42] a test event
...
print(y)
#> WARN  [2026-01-30 11:27:42] a gps track  {waypoints: `10`, location: `Austria`}
