...
print(x)
#> WARN  [2026-06-03 05:02:26] a test event
print(x, fmt = c("%t (%p) %c: %n - %m"))
#> 2026-06-03 05:02:26 (6872) testfun(): 300 - a test event
print(x, colors = NULL)
#> WARN  [2026-06-03 05:02:26] a test event
...
print(y)
#> WARN  [2026-06-03 05:02:26] a gps track  {waypoints: `10`, location: `Austria`}
