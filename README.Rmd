...
to extend and customise lgr, for example with their own appenders Loggers or 
Appenders. 
...
using lgr with a database, I would be grateful for any kind of 
feedback.^[The only database logging I can currently test extensively is DB2 via RJDBC. I do not recommend this setup if you have other options.]
