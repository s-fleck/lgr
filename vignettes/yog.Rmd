...
Yog comes with a pre-configured logger included. If you do not care about using 
multiple loggers, and do not want to deal with R6 classes you can use the 
the log functions that come with yog. The names of the functions are just the
default log levels in capital letters.
