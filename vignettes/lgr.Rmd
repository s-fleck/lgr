...
For production setups with multiple named loggers, reusable appenders/layouts,
and clear references (similar to python logging or NLog style configs), use
the extended schema and apply it to the root logger:
...
package. This solution works in most scenarios, but not in all
